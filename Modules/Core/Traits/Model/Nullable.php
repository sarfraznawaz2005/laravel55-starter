 ...
 * where the relationship is not yet established.
 *
 * Laravel <= 5.3 does not currently support automatically setting nullable database
 * fields as null when the value assigned to a given attribute is empty.
 */
trait Nullable
{
    /**
